...
window.INBARBER_TRANSLATIONS = {
  ...
  pt: {
    ...
    /* ---------- HOME · Hero ---------- */
    "hero.titleHtml": "Seu corte marcado<br>em <span class=\"text-gradient\">um minuto</span>.",
    "hero.subtitle":
      "Compare as barbearias perto de você, veja a avaliação de quem já sentou na cadeira e feche o horário aqui mesmo. Sem ligação, sem fila de espera, sem app para instalar.",
    "hero.stat1Label": "barbearias parceiras",
    "hero.stat2Label": "horários já agendados",
    "hero.stat3Label": "nota média dos clientes",
    ...
    "search.formLabel": "Buscar barbearias por cidade, dia e horário",
    "search.whereLabel": "Onde",
    "search.wherePlaceholder": "Digite uma cidade ou bairro",
    ...
    "search.openWhere": "Escolher a cidade",
    "search.openWhen": "Escolher o dia",
    "search.openTime": "Escolher o período do dia",
    "search.clearWhere": "Limpar a cidade escolhida",
    "search.quickLabel": "Ir direto para",
    "search.nearMe": "Perto de mim",
    "search.shopsInCity": "{count} barbearias em {city}",
    "search.oneShopInCity": "1 barbearia em {city}",
    "search.selected": "{field}: {value}",
    ...
    "news.count": "{count} novas nos últimos {days} dias",
    "news.dot": "Ver a barbearia {index} de {total}",
    "news.railHint": "Arraste para o lado ou use as setas do teclado para percorrer a lista.",
    "news.joinedLabel": "Entrada na plataforma",

    /* ---------- HOME · Abertas agora ---------- */
    "open.title": "Abertas agora",
    "open.subtitle":
      "Barbearias de portas abertas neste momento, na ordem do ranking. Cada card mostra até que horas dá tempo de chegar.",
    "open.subtitleCity":
      "Abertas neste momento, começando pelas de {city}. Cada card mostra até que horas dá tempo de chegar.",
    "open.listLabel": "Barbearias abertas neste momento",
    "open.count": "{count} abertas",
    "open.countOne": "1 aberta",
    "open.badge": "Aberta agora",
    ...
    /* ---------- Conta do usuário ---------- */
    "account.title": "Entre na InBarber",
    "account.intro": "Sua conta guarda as barbearias favoritas e deixa o agendamento a um toque.",
    "account.introFavorite": "Entre para salvar {name} nas suas favoritas.",
    "account.nameLabel": "Nome",
    "account.namePlaceholder": "Como podemos te chamar?",
    "account.emailLabel": "E-mail",
    "account.emailPlaceholder": "voce@email.com",
    "account.submit": "Entrar",
    "account.close": "Fechar",
    "account.errorName": "Diga seu nome para continuarmos.",
    "account.errorEmail": "Digite um e-mail válido.",
    "account.note": "Sessão de demonstração: os dados ficam guardados neste navegador e não são enviados a nenhum servidor.",
    "account.menuLabel": "Sua conta na InBarber",
    "account.signedInAs": "Sessão iniciada como",
    "account.favoritesNone": "Nenhuma barbearia favorita ainda",
    "account.favoritesOne": "1 barbearia favorita",
    "account.favoritesMany": "{count} barbearias favoritas",
    "account.signOut": "Sair da conta",
    "account.greeting": "Olá, {name}",

    /* ---------- Favoritas ---------- */
    "fav.add": "Salvar {name} nas favoritas",
    "fav.remove": "Tirar {name} das favoritas",
    "fav.locked": "Entre na sua conta para salvar {name} nas favoritas",
    "fav.saved": "{name} entrou nas suas favoritas",
    "fav.removed": "{name} saiu das suas favoritas",
    ...
    "shops.openNow": "Aberta agora",
    "shops.closed": "Fechada",
  ...
  en: {
    ...
    /* ---------- HOME · Hero ---------- */
    "hero.titleHtml": "Your cut, booked<br>in <span class=\"text-gradient\">one minute</span>.",
    "hero.subtitle":
      "Compare the barbershops near you, read the ratings of people who have actually sat in the chair and lock in your slot right here. No phone calls, no waiting around, no app to install.",
    "hero.stat1Label": "partner barbershops",
    "hero.stat2Label": "slots already booked",
    "hero.stat3Label": "average customer rating",
    "hero.imageAlt": "Barber finishing a fade on a client in a neon-lit barbershop",
    "hero.scroll": "Scroll to explore",
    "hero.trustLabel": "Partner barbershops in",

    /* ---------- Busca com filtros (hero + página de barbearias) ---------- */
    "search.formLabel": "Search barbershops by city, day and time",
    "search.whereLabel": "Where",
    "search.wherePlaceholder": "Type a city or neighbourhood",
    ...
    "search.openWhere": "Choose the city",
    "search.openWhen": "Choose the day",
    "search.openTime": "Choose the time of day",
    "search.clearWhere": "Clear the selected city",
    "search.quickLabel": "Jump to",
    "search.nearMe": "Near me",
    "search.shopsInCity": "{count} barbershops in {city}",
    "search.oneShopInCity": "1 barbershop in {city}",
    "search.selected": "{field}: {value}",
    ...
    "news.next": "See next",
    "news.count": "{count} new in the last {days} days",
    "news.dot": "See barbershop {index} of {total}",
    "news.railHint": "Drag sideways or use the arrow keys to move through the list.",
    "news.joinedLabel": "Joined the platform",

    /* ---------- HOME · Open right now ---------- */
    "open.title": "Open right now",
    "open.subtitle":
      "Barbershops with the doors open right now, in ranking order. Each card shows how long you still have to get there.",
    "open.subtitleCity":
      "Open right now, starting with the ones in {city}. Each card shows how long you still have to get there.",
    "open.listLabel": "Barbershops open right now",
    "open.count": "{count} open",
    "open.countOne": "1 open",
    "open.badge": "Open now",
    ...
    /* ---------- User account ---------- */
    "account.title": "Sign in to InBarber",
    "account.intro": "Your account keeps your favourite barbershops and puts booking one tap away.",
    "account.introFavorite": "Sign in to save {name} to your favourites.",
    "account.nameLabel": "Name",
    "account.namePlaceholder": "What should we call you?",
    "account.emailLabel": "Email",
    "account.emailPlaceholder": "you@email.com",
    "account.submit": "Sign in",
    "account.close": "Close",
    "account.errorName": "Tell us your name to continue.",
    "account.errorEmail": "Enter a valid email address.",
    "account.note": "Demo session: your details stay in this browser and are never sent to a server.",
    "account.menuLabel": "Your InBarber account",
    "account.signedInAs": "Signed in as",
    "account.favoritesNone": "No favourite barbershops yet",
    "account.favoritesOne": "1 favourite barbershop",
    "account.favoritesMany": "{count} favourite barbershops",
    "account.signOut": "Sign out",
    "account.greeting": "Hi, {name}",

    /* ---------- Favourites ---------- */
    "fav.add": "Save {name} to favourites",
    "fav.remove": "Remove {name} from favourites",
    "fav.locked": "Sign in to save {name} to your favourites",
    "fav.saved": "{name} is now one of your favourites",
    "fav.removed": "{name} is no longer one of your favourites",
  ...
  es: {
    ...
    /* ---------- HOME · Hero ---------- */
    "hero.titleHtml": "Tu corte reservado<br>en <span class=\"text-gradient\">un minuto</span>.",
    "hero.subtitle":
      "Compara las barberías cerca de ti, mira la valoración de quien ya pasó por la silla y cierra tu hora aquí mismo. Sin llamadas, sin colas, sin app que instalar.",
    "hero.stat1Label": "barberías asociadas",
    "hero.stat2Label": "horarios ya reservados",
    "hero.stat3Label": "nota media de los clientes",
    ...
    /* ---------- Busca com filtros (hero + página de barbearias) ---------- */
    "search.formLabel": "Buscar barberías por ciudad, día y horario",
    "search.whereLabel": "Dónde",
    "search.wherePlaceholder": "Escribe una ciudad o barrio",
    ...
    "search.openWhere": "Elegir la ciudad",
    "search.openWhen": "Elegir el día",
    "search.openTime": "Elegir la franja del día",
    "search.clearWhere": "Borrar la ciudad elegida",
    "search.quickLabel": "Ir directo a",
    "search.nearMe": "Cerca de mí",
    "search.shopsInCity": "{count} barberías en {city}",
    "search.oneShopInCity": "1 barbería en {city}",
    "search.selected": "{field}: {value}",
    ...
    "news.count": "{count} nuevas en los últimos {days} días",
    "news.dot": "Ver la barbería {index} de {total}",
    "news.railHint": "Arrastra hacia los lados o usa las flechas del teclado para recorrer la lista.",
    "news.joinedLabel": "Entrada en la plataforma",

    /* ---------- HOME · Abiertas ahora ---------- */
    "open.title": "Abiertas ahora",
    "open.subtitle":
      "Barberías con las puertas abiertas ahora mismo, en el orden del ranking. Cada tarjeta indica hasta qué hora te da tiempo de llegar.",
    "open.subtitleCity":
      "Abiertas ahora mismo, empezando por las de {city}. Cada tarjeta indica hasta qué hora te da tiempo de llegar.",
    "open.listLabel": "Barberías abiertas en este momento",
    "open.count": "{count} abiertas",
    "open.countOne": "1 abierta",
    "open.badge": "Abierta ahora",
    ...
    /* ---------- Cuenta del usuario ---------- */
    "account.title": "Entra en InBarber",
    "account.intro": "Tu cuenta guarda las barberías favoritas y deja la reserva a un toque.",
    "account.introFavorite": "Entra para guardar {name} en tus favoritas.",
    "account.nameLabel": "Nombre",
    "account.namePlaceholder": "¿Cómo te llamamos?",
    "account.emailLabel": "Correo electrónico",
    "account.emailPlaceholder": "tu@email.com",
    "account.submit": "Entrar",
    "account.close": "Cerrar",
    "account.errorName": "Dinos tu nombre para continuar.",
    "account.errorEmail": "Escribe un correo electrónico válido.",
    "account.note": "Sesión de demostración: los datos se quedan en este navegador y no se envían a ningún servidor.",
    "account.menuLabel": "Tu cuenta de InBarber",
    "account.signedInAs": "Sesión iniciada como",
    "account.favoritesNone": "Todavía no tienes barberías favoritas",
    "account.favoritesOne": "1 barbería favorita",
    "account.favoritesMany": "{count} barberías favoritas",
    "account.signOut": "Cerrar sesión",
    "account.greeting": "Hola, {name}",

    /* ---------- Favoritas ---------- */
    "fav.add": "Guardar {name} en favoritas",
    "fav.remove": "Quitar {name} de favoritas",
    "fav.locked": "Entra en tu cuenta para guardar {name} en favoritas",
    "fav.saved": "{name} entró en tus favoritas",
    "fav.removed": "{name} salió de tus favoritas",
    ...
    "shops.openNow": "Abierta ahora",
    "shops.closed": "Cerrada",
